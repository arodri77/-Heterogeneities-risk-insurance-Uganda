# -*- coding: utf-8 -*-
"""
Created on Sat May  5 16:49:30 2018
...
os.chdir('D:/Documents/Documents/IDEA/Master tesi/Data shocks')
...
# Import data
# =============================================================================
shocks = pd.read_stata('GSEC16_10.dta', convert_categoricals=False)
shocks.columns = ["hh", "shock_code", "shock_d", "shock_month", "shock_long", "income","assets","food_prod","food_purch","cope1","cope2","cope3"]       
...
d={101:'Drought-irreg rains', 103:'Landslides-Erosion', 102:"floods", 104:"crop pest", 105: "livestock pest", 106:'↑P inp', 107:'↓P outp',  108:'↓wage', 109:'Unemp', 110:'Illness_inc',
...
for i in range(0,len(shocks)):
    #climate shock
    shocks.iloc[i,4] = ((shocks.iloc[i,1] == 1) &((shocks.iloc[i,3] == 'Drought-irreg rains')  | (shocks.iloc[i,3] == 'Landslides-Erosion')   | (shocks.iloc[i,3] == 'floods')))*1
    #prices shock
    ...
    #aggregate shock
    shocks.iloc[i,8] =  ((shocks.iloc[i,1] == 1) &((shocks.iloc[i,3] == 'Drought-irreg rains')  | (shocks.iloc[i,3] == 'Landslides-Erosion') | (shocks.iloc[i,3] == 'floods')  | (shocks.iloc[i,3] == '↑P inp')  | (shocks.iloc[i,3] == '↓P outp')))*1
...
for item in ["shock","climate","prices","job","health","aggregate","idiosyn", "pests"]:
...
shockshh.to_csv("D:/Documents/Documents/IDEA/Master tesi/Data & Code (Uganda)/Data10/shocks10.csv", index=False)
...
# Import data
# =============================================================================
shocks = pd.read_stata('GSEC16_09.dta', convert_categoricals=False)
shocks.columns = ["hh", "shock_code", "shock_d", "shock_month", "shock_long", "income","assets","food_prod","food_purch","cope1","cope2","cope3"]       
shocks['shock_d'] =(shocks['shock_d']==1)*1
shocks = shocks[["hh","shock_d","shock_code"]]
...
#Export dataset
shockshh["hh"] = shockshh.index.values
shockshh.to_csv("D:/Documents/Documents/IDEA/Master tesi/Data & Code (Uganda)/data09/shocks09.csv", index=False)
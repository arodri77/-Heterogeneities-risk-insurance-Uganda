...
os.chdir('D:/Documents/Documents/IDEA/Master tesi/Data & Code (Uganda)/Data10')
...
ag5a = ag5a[["HHID","cropID","a5aq6a","a5aq6c","a5aq6d","a5aq7a","a5aq7c","a5aq8","a5aq10","a5aq12","a5aq13","a5aq14a","a5aq14b","a5aq22"]]
...
cprices= pd.read_csv("pricesfood10.csv")
...
prices.to_csv("cropprices10.csv")
...
ag5b = ag5b[["HHID","cropID","a5bq6a","a5bq6c","a5bq6d","a5bq7a","a5bq7c","a5bq8","a5bq10","a5bq12","a5bq13","a5bq14a","a5bq14b","a5bq22"]]
...
ag8["c_animal"] = ag8[["month_c"]]*12
ag8 = ag8.groupby(by="hh").sum()
...
animal_c = pd.read_csv("c_animal10.csv")
...
farm.to_csv("income_agsec_10.csv")
